%   A modified version of barwitherr function. The negative error bars have
%   been removed.
%
%
%
...
%   28/05/2018  Usman Rashid            Removed lower edges of error bars
%                                       for better appearance in case of
%                                       non-negative data. Also changed the
%                                       name to barwitherrnn.
%
%**************************************************************************

function varargout = barwitherrnn(errors,varargin)
...
if nRows > 1
    ...
    for col = 1:nCols
        ...
        hErrorbar(col) = errorbar(mean(x,1), values(xOrder,col), NaN.*lowerErrors(xOrder,col), upperErrors(xOrder, col), '.k');
